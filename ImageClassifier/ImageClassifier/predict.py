...
def main():
    ...
    training_loader, testing_loader, validation_loader, _ = Common.load_data()

    print("Loading pre-trained model...")
    model = Common.load_checkpoint(checkpoint_path, hardware)

    print("Running inference...")
    probabilities = Common.predict(image_path, model, 5, hardware)
